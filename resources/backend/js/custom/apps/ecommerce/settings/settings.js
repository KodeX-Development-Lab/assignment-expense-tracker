...
var KTAppEcommerceSettings = {
    init: function () {
        [
            ...
            "kt_ecommerce_settings_other_form",
            ...
            i.addEventListener("click", function (e) {
                var form = $(this).data('form'); /* need to add (eg: data-form="kt_ecommerce_settings_general_form") */
                        ...
                        s.validate().then(function (e) {
                            console.log("validated!"),
                                "Valid" == e
                                    ...
                                    : Swal.fire({
                                          text: "Warning! Please fill form data first.",
                                          icon: "error",
                                          buttonsStyling: !1,
